...
<body>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="name" id="name" required placeholder="Enter your name" value="<?php echo $name; ?>"><br>
		...
		<input type="password" name="cpassword" id="cpassword" value="<?php echo $cpassword; ?>" required><br>
